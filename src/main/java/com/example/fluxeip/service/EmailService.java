...
public class EmailService {
	...
	public void sendVerificationEmail(String to, String token) {
        ...
        message.setText("修改密碼, 點擊以下網址: "
                + "https://fluxeipfrontend.onrender.com/reset-password?token=" + token);
	...
	public void sendNewEmployee(String to,Integer id) throws MessagingException {
        ...
        String htmlContent = "<html><body>"
                ...
                + "<p>登入網址：<a href='https://fluxeipfrontend.onrender.com/'>點此登入</a></p>"
                + "<p>祝您工作愉快！</p>"
                + "</body></html>";
...
//                + "您的密碼: 1234 登入網址:https://fluxeipfrontend.onrender.com/");
//        emailSender.send(message);
	}
